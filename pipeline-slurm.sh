...
#SBATCH -o pipe-slurm.%N.%j.out # STDOUT<<<<<<< HEAD
#SBATCH -e pipeslurm.%N.%j.err # STDERR
...
aws sns publish --topic-arn arn:aws:sns:ap-southeast-1:378508218766:awsnotify --message "JobDone"
